...
**Status:** Rules are updated and ready to publish to Firebase Console

---

## The Updated Rule (Lines 46-50)

```javascript
// Owner can update, OR anyone can update device token fields only
// (This is needed for logging out other device from login screen)
...
3. **Replace All Content**
   ...
   - Open file: `c:\Users\csp\Documents\plink-live\firestore.rules` in your editor
   - Copy entire content (Ctrl+C)
...
Copy-paste this entire file to your Firebase Console:
...
1. Firebase Console shows no errors
2. Rules show the new update rule (lines 48-50)
3. Status shows "Rules updated successfully"

---

## Key Change

Lines 48-50 now allow unauthenticated users to delete device tokens:
...
This is the critical fix for the logout system to work!
