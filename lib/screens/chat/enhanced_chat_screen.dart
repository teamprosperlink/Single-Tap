    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: ConstrainedBox(
          ...
          child: Stack(
            children: [
              // Image - show local file during upload, cloud URL after
              if (hasLocalPath && isUploading)
                // Show local file with slight blur during upload (WhatsApp style)
                Image.file(
                ...
                // Show cloud image after upload complete
                CachedNetworkImage(
