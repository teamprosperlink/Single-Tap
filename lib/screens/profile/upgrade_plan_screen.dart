          ...
          child: Column(
            children: [
              Expanded(
                child: TabBarView(
                  controller: _tabController,
                  children: [_buildPersonalPlans(), _buildBusinessPlans()],
                ),
              ),
              // Continue Button
      ...
      children: [
        ...
        _buildPlanCard(
          ...
          features: [
            ...
            _PlanFeature(
              Icons.auto_awesome,
              'Produce images, videos, slides, & more',
            ),
            _PlanFeature(
              Icons.security_outlined,
              'Secure your space with SSO, MFA, & more',
            ),
            _PlanFeature(
              Icons.privacy_tip_outlined,
              'Protect privacy: data never used for training',
            ),
            _PlanFeature(
            ...
            _PlanFeature(
              ...
              'Integrate with SharePoint & other tools',
            ),
            _PlanFeature(
              Icons.receipt_long_outlined,
              'Simplify billing and user management',
            ),
            _PlanFeature(
              Icons.mic_outlined,
              'Capture meeting notes with transcription',
            ),
            _PlanFeature(
              Icons.smart_toy_outlined,
              'Deploy agents to code and research',
            ),
          ],
          footerText:
